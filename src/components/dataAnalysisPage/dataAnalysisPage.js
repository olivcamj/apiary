      ...
      <Wrapper>
        <IntroWrapper>
          <TextWrapper>
            ...
            <TextIntro>
              Practicum by Yandex students are ready to undertake analytics of
              the data provided by the company or if necessary, are ready to
              conduct market research to obtain the necessary data for analysis.
            </TextIntro>
          </TextWrapper>
        ...
        <CardWrapper>
          <ProjectPageCard>
            ...
            <ProjectPageCardText>
              We will analyze your data, competitors open data, market
              conditions, and current trends. We will share our conclusions and
              recommendations regarding the pricing policy of your company.
            </ProjectPageCardText>
          </ProjectPageCard>
          <ProjectPageCard>
            ...
            <ProjectPageCardTitle>
              We can build
              <br /> a recommendation model
            </ProjectPageCardTitle>
            <ProjectPageCardText>
              We will customize issued recommendations. We will analyze data on
              the behavior of your clients. You will be able to quickly
              understand what to offer so that they take the suggested action.
            </ProjectPageCardText>
          </ProjectPageCard>
          <ProjectPageCard>
            ...
            <ProjectPageCardText>
              We will divide users into segments, select a core, segment them by
              interests, and give recommendations regarding the most popular
              content for each group to increase their retention or formulate a
              discount policy.
            </ProjectPageCardText>
          </ProjectPageCard>
        </CardWrapper>

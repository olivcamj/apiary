      ...
      <Wrapper>
        ...
        <CardWrapper>
          <ProjectPageCard>
            ...
            <ProjectPageCardText>
              We handle photo recognition of texts of different languages
              ranging from English to Arabic.
            </ProjectPageCardText>
          </ProjectPageCard>
          <ProjectPageCard>
            <ProjectPageCardNumber>2</ProjectPageCardNumber>
            <ProjectPageCardTitle>
              Checking and improving existing algorithms
            </ProjectPageCardTitle>
            <ProjectPageCardText>
              We test the algorithms available to your company, check them using
              your data or open data, and suggest hypotheses for improvement.
            </ProjectPageCardText>
          </ProjectPageCard>
          <ProjectPageCard>
            <ProjectPageCardNumber>3</ProjectPageCardNumber>
            <ProjectPageCardTitle>
              Recognition of audio and video files
            </ProjectPageCardTitle>
            <ProjectPageCardText>
              We can recognize files of different types, create algorithms for
              finding errors in them, and generating reports.
            </ProjectPageCardText>
          </ProjectPageCard>
        </CardWrapper>
      </Wrapper>
